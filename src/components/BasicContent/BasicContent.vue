<template>
  <div class="basic-content">
    <div>
      <div class="basic-content-apy">
        ...
        <div class="basic-content-apy-tooltip">
          <Tooltip v-model:showTooltip="hideTooltipAPY">
      ...
      <div class="basic-content-tvl">
        ...
        <div class="basic-content-tvl-tooltip">
          <Tooltip v-model:showTooltip="hideTooltipTVL">
    ...
    <div class="basic-content-btn">
      <Button @click="handlerShow"> Connect wallet </Button>
    </div>
  </div>
</template>
...
import TooltipContainer from "../Tooltip/Tooltip.vue";
